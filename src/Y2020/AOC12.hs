...
solution1 :: Input -> Int
solution1 input =
  let commands = parseOrDie inputParser input
      ship = mkShip
      afterwards = foldl moveShip ship commands
   in manhattanDistance (0, 0) (position afterwards)
...
solution2 input =
  let commands = parseOrDie inputParser input
      ship = mkShip
      afterwards = foldl moveShipAndWaypoint ship commands
   in manhattanDistance (0, 0) (position afterwards)

solution :: Solution
solution = PureSolution solution1 2297 solution2 89984
