...
solution :: Solution
solution = PureSolution solution1 46978532 solution2 163035127721

-- 46978532
solution1 :: Input -> Int
solution1 _input = result $ nTimes 100 move $ setup input

-- 163035127721
solution2 :: Input -> Int
solution2 _input = result2 $ nTimes 10000000 move $ part2 input
...
move g =
  let next3@(x, y, z) = takeNext3Cups g (current g)
      ...
      cups' =
        M.insert (current g) (successors g M.! z) $
...
result :: Game -> Int
result g = toOneInt $ drop 1 $ listify g
